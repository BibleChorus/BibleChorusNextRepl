      ...
      <div className="min-h-screen bg-gradient-to-br from-violet-50/40 via-white to-fuchsia-50/24 dark:from-violet-950/40 dark:via-slate-900 dark:to-fuchsia-950/24">
        ...
        >
          ...
          <div className="absolute inset-0">
            ...
            <div className="absolute top-0 -left-8 w-96 h-96 bg-violet-400/14 rounded-full mix-blend-multiply filter blur-3xl opacity-60 animate-blob"></div>
            <div className="absolute top-12 -right-8 w-80 h-80 bg-fuchsia-400/14 rounded-full mix-blend-multiply filter blur-3xl opacity-60 animate-blob animation-delay-2000"></div>
